...
TAGS_CUSTOM: Final = {
    "bodypart": ["body", "pussy", "ass", "breast", "face", "foot", "leg", "mouth", "hand", "thigh","penis","insert","job", "_step","_penis","+penis","_1gts0", "__tbr"],
...
class TaggerWD:
    ...
    def tags_prompt(self, tags_raw: dict, thresh: float = 0.3, trigger: str = "", max_tags: int = 30, do_bodypart: bool = False) -> list[str]:
        """
        ...
        if trigger == "1gts":
            avoid_tags_set += TAGS_AVOID_1GTS
