...
class AppHtml:
    ...
    @staticmethod
    def elem_id_simg_editor_delete_button() -> str:
        return AppHtml.make_elem_id_hidden_button('simg_editor_delete')

    @staticmethod
    def elem_id_simg_editor_delete_databus() -> str:
        return AppHtml.make_elem_id_databus_textbox('simg_editor_delete')
