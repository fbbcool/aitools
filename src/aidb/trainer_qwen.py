...
class Trainer:
    ...
    MODEL_REPO_ID_QWEN: Final = None
    MODEL_FILE_QWEN: Final = None
    MODEL_REPO_ID_FLUX: Final = "Kijai/flux-fp8"
    MODEL_FILE_FLUX: Final = "flux1-dev-fp8.safetensors"
    #MODEL_REPO_ID_BASE: Final = "NSFW-API/NSFW_Wan_14b"
    MODEL_REPO_ID_BASE: Final = "Qwen/Qwen-Image"
    ...
    def __init__(self, repo_id: str, load_models: bool = True, cache_full_dataset: bool = False, multithread: bool = False, caption_missing=False, caption_force=False) -> None:
        ...
        self._hfdl_ckpt_wan: tuple[str,str] | None = (self.MODEL_REPO_ID_BASE, self.MODEL_FILE_WAN)
        ...
        self._file_llm: str = ""
        self._folder_base_model: str = "" # base ckpt full checkout w/o models, only config (e.eg. for WAN)
    ...
    def _download_base_model(self, repo_id: str, ignore_patterns: list[str] = []):
        #self._folder_ckpt_base = snapshot_download(repo_id="Wan-AI/Wan2.1-T2V-14B", ignore_patterns=["diffusion_pytorch_model*", "models_t5*"])
        self._folder_base_model = snapshot_download(repo_id=repo_id, ignore_patterns=ignore_patterns)
    ...
    def _download_models_wan(self, force: bool = False) -> None:
        ...
        self._file_vae = None
        self._folder_base_model = snapshot_download(repo_id="Wan-AI/Wan2.1-T2V-14B", ignore_patterns=["diffusion_pytorch_model*", "models_t5*"])
...
ckpt_path = '{self._folder_base_model}'
...
""" 
    ...
    def make_config(cls, imgs: list[str]) -> None:
        ...
        config["batch_size"] = 2
        config["prompts"] = []
        config["model"] = {"hf": {"repo_id": cls.MODEL_REPO_ID_BASE, "file": cls.MODEL_FILE_WAN}, "cai": {"url": ""}}
        config["imgs"] = imgs
