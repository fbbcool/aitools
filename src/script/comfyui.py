...
class ModelInstComfyUi:
    def __init__(self, group = DownloadGroup.SD15) -> None:
        ...
        models_hidream: list[ModelInst] = [
            ...
            ModelInst(t, ModelType.Clip, hf, "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/resolve/main/split_files/text_encoders/clip_l_hidream.safetensors?download=true", ""),
            ModelInst(t, ModelType.Clip, hf, "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/resolve/main/split_files/text_encoders/llama_3.1_8b_instruct_fp8_scaled.safetensors?download=true", ""),
            ModelInst(t, ModelType.Clip, hf, "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/resolve/main/split_files/text_encoders/t5xxl_fp8_e4m3fn_scaled.safetensors?download=true", ""),
