...
class ModelInstComfyUi:
    def __init__(self, group = DownloadGroup.SD15) -> None:
        ...
        models_flux_refine: list[ModelInst] = [
            ...
            ModelInst(t, ModelType.Checkpoint, cai, "https://civitai.com/api/download/models/1908093?type=Model&format=SafeTensor&size=full&fp=fp8", ""),
        ...
        models_hidream: list[ModelInst] = [
            ...
            ModelInst(t, ModelType.Clip, wget, "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/resolve/main/split_files/text_encoders/llama_3.1_8b_instruct_fp8_scaled.safetensors?download=true", "llama_3.1_8b_instruct_fp8_scaled"),
            ModelInst(t, ModelType.Clip, wget, "https://huggingface.co/Comfy-Org/HiDream-I1_ComfyUI/resolve/main/split_files/text_encoders/t5xxl_fp8_e4m3fn_scaled.safetensors?download=true", "t5xxl_fp8_e4m3fn_scaled"),
