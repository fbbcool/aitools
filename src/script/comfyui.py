...
class ModelInstComfyUi:
    def __init__(self, group = DownloadGroup.SD15) -> None:
        ...
        models_flux: list[ModelInst] = [
            ModelInst(t, ModelType.Unet, hf, "https://huggingface.co/city96/FLUX.1-dev-gguf/resolve/main/flux1-dev-Q8_0.gguf", "flux1-dev-q8_gguf"),
            ...
            ModelInst(t, ModelType.Clip, wget, "https://huggingface.co/zer0int/CLIP-GmP-ViT-L-14/blob/main/ViT-L-14-TEXT-detail-improved-hiT-GmP-TE-only-HF.safetensors", "clip_l_improve"),
            ...
            ModelInst(t, ModelType.Clip, wget, "https://huggingface.co/city96/t5-v1_1-xxl-encoder-gguf/resolve/main/t5-v1_1-xxl-encoder-Q8_0.gguf?download=true", "t5_q8_gguf"),
            ModelInst(t, ModelType.Clip, wget, "https://huggingface.co/city96/t5-v1_1-xxl-encoder-gguf/resolve/main/t5-v1_1-xxl-encoder-f16.gguf?download=true", "t5_gguf"),
